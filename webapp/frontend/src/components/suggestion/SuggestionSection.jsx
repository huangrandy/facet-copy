...
export const SuggestionSection = ({ formatDict, featureDict, selectedInstance, explanations, currentExplanationIndex }) => {
    ...
    if (currentExplanation === undefined) { // If the ranges are undefined
        return (
            <div id="suggestion-grid" className='card'>
                <h2>Suggestions</h2>
                <i className="instructions-text">No suggestions available.</i>
            </div>
        )
    }
    else {
